  ...
  resources: {
    ...
    ar: {
      translation: {
        ...
        features_p1_p2: 'تم منح مجموعة العقيد عقدًا متعدد السنوات لتوفير تدريب أمني',
        ...
        com_leading_p1: 'ذراعك القوي في المشتريات الشاملة، بخبرة منذ عام ٢٠٠٤ في تلبية احتياجات القطاعات المدنية والعسكرية بكفاءة وموثوقية. تعرف على المزيد حول تجارة العقيد الجنرال.',
